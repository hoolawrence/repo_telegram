...
public class BuildVars {
    ...
    public static int APP_ID = BuildConfig.TARK_API_ID;
    public static String APP_HASH = BuildConfig.TARK_API_HASH;

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=app.tark.client";
